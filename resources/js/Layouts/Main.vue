        ...
        <nav class="p-6 mx-auto max-w-screen-lg flex items-center justify-between">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div v-if="user" class="relative">
                    ...
                    <!----------- User Dropdown Menu ----------->
                    <div v-show="show" @click="show=false" class="absolute z-50 top-16 right-0 bg-slate-800 text-white rounded-lg border-slate-300 border overflow-hidden w-40">
                ...
                <button 
                    @click="switchTheme()"
                    class="w-6 h-6 hover:bg-slate-700 grid place-items-center rounded-full hover:outline outline-1">
